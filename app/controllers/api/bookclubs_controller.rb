class Api::BookclubsController < ApplicationController
    ...
    def show 
        bookclub = @bookclub
        render json: bookclub, include: ['users', 'bookclub_books', 'bookclub_books.book', 'bookclub_books.goals'], status: :ok
    ...
    def create 
        ...
        render json: bookclub, include: ['users', 'bookclub_books', 'bookclub_books.book', 'bookclub_books.goals'], status: :created
    ...
    def update 
        ...
        render json: bookclub, include: ['users', 'bookclub_books', 'bookclub_books.book', 'bookclub_books.goals'], status: :accepted
    end
    ...
    def current_book
        ...
        render bookclub, include: ['users', 'bookclub_books', 'bookclub_books.book', 'bookclub_books.goals'], status: :accepted
    end
